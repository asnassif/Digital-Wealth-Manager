...
let labels = ["Ticker Symbol","Company Name","Industry","Sector"];
...
let getMatchingRecords = (dt,flts) => {
    ...
    data.forEach((datum) => {
        ...
        && ((flts[0] === datum.Stock.toLowerCase()) || (flts[0] === ""))
        && ((flts[1] === datum.Company_Name.toLowerCase()) || (flts[1] === ""))
        && ((flts[2] === datum.Industry.toLowerCase()) || (flts[2] === ""))
        && ((flts[3] === datum.Sector.toLowerCase()) || (flts[3] === ""))){
            records.push(datum);
        }
    });
    return records;
